...
const companies = [
  {
    name: "Reliance",
    instagram: "https://www.instagram.com/reliance_digital/embed",
  },
  {
    name: "Tata Motors",
    instagram: "https://www.instagram.com/tatasteelltd/embed",
  },
...
const ReportPage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="container mx-auto p-8">
        <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">
          Select a Company to View Report
        </h1>
        ...
        {selectedCompany && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 transition transform hover:shadow-xl ">
              <h2 className="text-xl font-semibold mb-4 text-blue-900">
                Latest Information about stocks
              </h2>
              
              <p>
    You can view the latest information on stocks directly from Economic Times by 
    <br/>
    <br/>
    <a 
      href="https://economictimes.indiatimes.com/tata-steel-ltd/stocks/companyid-12902.cms" 
      target="_blank" 
    ...
    <br/>
    <a 
      href="https://groww.in/stocks/tata-steel-ltd" 
      target="_blank" 
      rel="noopener noreferrer" 
      className="text-blue-500 hover:underline"
    >
      https://groww.in/stocks/tata-steel-ltd
    </a>
    <br/>
    <a 
      href="https://www.moneycontrol.com/india/stockpricequote/ironsteel/tatasteel/TIS" 
      target="_blank" 
      rel="noopener noreferrer" 
      className="text-blue-500 hover:underline"
    >
